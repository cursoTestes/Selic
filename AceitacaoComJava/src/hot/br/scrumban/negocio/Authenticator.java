...
import br.scrumban.entity.FalhaLogin;
...
public class Authenticator
{
    ...
    public boolean authenticate()
    {
        ...
        if(u.getSenha().equals(credentials.getPassword()))
        {
        ...
        } else 
        {
        	...
        	falhaLogin.setUsuarioId(u.getUsuarioId());
        	falhaLogin.setDataOcorrencia(new Date());
        	falhaLoginHome.setInstance(falhaLogin);
        	falhaLoginHome.persist();
